<script>
	...
	let sample_data = [
		{title: "Search for a Better Salary/Livelihood", count: 627},
		{title: "Unemployment", count: 271},
		{title: "To Send Remitances", count: 118},
		{title: "Lack of Money to buy food/basic necessities", count: 328},
		{title: "Adventure Tourism", count: 42},
		{title: "Family Reunification", count: 35},
		{title: "Natural Calamity", count: 68},
		{title: "Others (Domestic/Gang Violence,etc.)", count: 118}
	]
