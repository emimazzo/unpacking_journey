<script>
	...
	let sample_data = [
		{title: "Search for a Better Salary/Livelihood", count: 746},
		{title: "Unemployment", count:238},
		{title: "To Send Remitances", count: 180},
		{title: "Lack of Money to buy food/basic necessities", count: 318},
		{title: "Adventure Tourism", count: 86},
		{title: "Family Reunification", count:  75},
		{title: "Natural Calamity", count:  42},
		{title: "Others (Domestic/Gang Violence,etc.)", count: 133}
	]
