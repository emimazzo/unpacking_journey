<script>
	...
	let sample_data = [
		{title: "Search for a Better Salary/Livelihood", count:  412},
		{title: "Unemployment", count: 151},
		{title: "To Send Remitances", count: 87},
		{title: "Lack of Money to buy food/basic necessities", count: 250},
		{title: "Adventure Tourism", count: 29},
		{title: "Family Reunification", count: 23},
		{title: "Natural Calamity", count: 14},
		{title: "Others (Domestic/Gang Violence,etc.)", count: 47}
	]
